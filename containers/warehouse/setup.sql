...
CREATE TABLE STG.autoline (
    AD_ID VARCHAR(20),
    INFORMACOES_ADICIONAIS VARCHAR(1000),
...
DROP TABLE IF EXISTS DB.FACT_AD;
DROP TABLE IF EXISTS DB.DIM_AD;
DROP TABLE IF EXISTS DB.DIM_CARS;
DROP TABLE IF EXISTS DB.DIM_RESOURCES;
DROP SCHEMA IF EXISTS DB;
CREATE SCHEMA DB;
CREATE TABLE DB.DIM_RESOURCES(
    RESOURCE_KEY INT,
    FINANCIAVEL INT,
    FINANCIADO INT,
    IMPOSTOS_PAGOS INT,
